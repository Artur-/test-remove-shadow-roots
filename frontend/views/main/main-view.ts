...
export class MainView extends LitElement {
  ...
  @property({ type: Array }) menuTabs: MenuTab[] = [
    ...
    { route: 'masteraddress-detail', name: 'Master_address-Detail' },
    { route: 'masterbook-detail', name: 'Master_book-Detail' },
    { route: 'masterfoodproduct-detail', name: 'Master_foodproduct-Detail' },
    { route: 'person-form', name: 'Person Form' },
    { route: 'address-form', name: 'Address Form' },
    { route: 'credit-card-form', name: 'Credit Card Form' },
  ];

  @property({ type: String }) projectName = 'remove-shadow-roots';
